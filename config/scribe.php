...
return [
    ...
    'description' => 'Laravel JWT API with Todo Management System. This API provides user authentication with JWT tokens and complete CRUD operations for todo management.',
